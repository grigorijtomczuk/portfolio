...
class INFO {
	...
	constructor() {
		...
		this.contact = {
			...
			description: `Спасибо за проявленный интерес и желание связаться со мной! Здесь Вы сможете найти мои контакты. Обращайтесь ко мне по любому поводу, будь то коммерческое предложение или же исключительно технический вопрос. Если Ваше сообщение не требует скорейшего ответа, я прошу Вас написать мне на <a class="general-link" href="mailto:${this.main.email}">почту</a>. В противном случае, пишите мне в <a class="general-link" href="${this.socials.telegram}" target="_blank">Telegram</a>, я почти всегда готов ответить.`,
		};
	}
}
